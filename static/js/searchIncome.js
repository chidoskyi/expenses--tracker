        ...
        .then((data) => {
            ...
            if (data.length === 0) {
                ...
                data.forEach(item => {
                    ...
                    const editUrl = `/edit-incomes/${item.id}`; // Adjust the URL pattern according to your Django URL configuration
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="/delete-incomes/${item.id}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>`;
